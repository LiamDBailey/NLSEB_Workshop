...
```{r}
plot_data <- read_csv(file = here("./data/practice_example1_data.csv"), show_col_types = FALSE) %>% 
...
plot_panthera <- read_csv(here("./data/practice_example2_data.csv"), show_col_types = FALSE)
...
```{r}
ghg_data <- read_csv(here("./data/practice_example3_data.csv"), show_col_types = FALSE) %>% 
